...
$app->post('/checkout', function() {
	...
	if (!isset($_POST['desnumber']) || $_POST['desnumber'] === '') {
		Address::setMsgError("Informe o número no endereço.");
		header('Location: /checkout');
		exit;
	}
...
$dadosboleto["demonstrativo1"] = "Pagamento de Compra na Loja tagui store E-commerce";
...
// SEUS DADOS
$dadosboleto["identificacao"] = "Tagui Store";
$dadosboleto["cpf_cnpj"] = "0001";
$dadosboleto["endereco"] = "Rua teste";
$dadosboleto["cidade_uf"] = "Passos MG";
$dadosboleto["cedente"] = "Tagui Store";
